        ...
        <footer>
            <div className="overflow-hidden flex flex-row justify-center items-center relative bg-slate-500 text-white">
                ...
                <div className="inline py-10 mx-auto">
                    <h1 className="text-3xl font-semibold"><img src="/favicon.ico" width="30" className="inline mx-auto"></img> nafu</h1>
            ...
            <div className="flex flex-col mx-auto items-right">
                ...
                <span className="flex items-center ml-auto text-white text-sm mr-1"><FaRegCopyright className="inline mr-1 text-white text-sm" /> {new Date().getFullYear()} Jariel Que</span>
                
                <span className="flex items-center ml-auto">Powered by 
                <img className="fill-white inline ml-1" src="vercel.svg"/></span>
