      ...
      <h3 className="text-2xl font-">Let's get in touch.</h3>
        ...
        <form action="">
            <div className="flex flex-row space-x-2">
                ...
                Your Name:
                    <input className="block rounded bg-white text-black mt-1" type="text" />
                </label>
                <label className="text-white" htmlFor="">
                Your Email:
                    <input className="block rounded bg-white text-black mt-1" type="text" />
            ...
            <div className="mt-2">
                <label className="text-white" htmlFor="">
                Your Message:
                    <textarea className="block rounded bg-white text-black mt-1" type="textarea" rows="5" cols="42" />
                </label>
            </div>
