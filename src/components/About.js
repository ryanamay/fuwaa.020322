export default function About() {
  return (
    <div className="flex flex-row flex-grow justify-center lg:mx-12 md:mx-0">
      ...
      <div className="flex-2 flex-col pl-12 pr-12 justify-center item-center lg:flex sm:hidden">
