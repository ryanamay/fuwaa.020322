    ...
    <div id="about" className="flex flex-row flex-grow justify-center pt-32 lg:mx-12 md:mx-0">
      <div className="flex flex-col flex-grow px-12 py-12 max-w-5xl">
        ...
        <p className="text-2xl justify max-w-prose">
         My name is Jariel and I&apos;m a full-time student, full-time intern typa' guy. Need something? Contact me and we&apos;ll talk it out.
        </p>

        <h3 className="inline text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-slate-400 to-slate-800 mt-10">Consider me if you want someone who's</h3>
